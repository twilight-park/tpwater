...
namespace eval ::i2c::MCP342x {
	...
	set REGISTER_CONFIG [expr {
	    $::i2c::MCP342x::$CMD_MODE_CONTINUOUS | $::i2c::MCP342x::CMD_SPS_15 | $::i2c::MCP342x::CMD_GAIN_4
	}]
	...
	oo::class create a2d {
		...
		method config { { c 0 } { e 1 } } {
			variable handle
			set register_config [expr { 
				([lindex $::i2c::MCP342x::REGISTER_SELECT $e $c] | $::i2c::MCP342x::REGISTER_CONFIG) 
			}] 

			puts $handle [binary format c $register_config]
		}
