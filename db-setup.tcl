...
tdbc::sqlite3::connection create db "$HOME/tpwater/TPWSM.db"
...
proc record { time_measured flow pres } {
    set time_recorded [clock seconds]
    sql db { insert into log 
	       (  time_recorded,  time_measured,  flow,  pres ) 
	values ( :time_recorded, :time_measured, :flow, :pres ) }
